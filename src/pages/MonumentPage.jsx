  ...
  return (
    <div className="row">
      <div className="d-flex">
        <div className="ml-[15%] col-xs-12 col-md-6 col-lg-6" style={{ width: "30%" }}>
        ...
        <div className="col-xs-12 col-md-6 col-lg-6">
          ...
          <img className="w-[40%] h-auto mt-2 mx-auto"
          src="/Image/Cesar.jpg" alt="Cesar" />
          <p className="mx-auto">
          ...
          <img className="w-[50%] h-auto mt-2 mx-auto"
          src="/Image/map.png" alt="map" />
          <p className="mx-auto">
