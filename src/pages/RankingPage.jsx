...
import DesktopRanking from '../components/RankingPage/DesktopRanking';
                    ...
                    {users.map((user, index) => (
                        <div key={index} style={{ backgroundColor: "#DEE6F0" }} className='d-flex align-items-center justify-content-between p-1 border-bottom border-black'>
                            <div className="d-flex align-items-center justify-content-center">
                                <img src={"/Image/PerfilPorDefecto.png"} alt="usuario avatar" style={{ width: "40px", height: "auto", marginRight: "10px" }} />
                                {user.name}
                            </div>
