...
const navigation = [
    ...
    { name: 'Acciones', path: '/acciones', current: true },
    { name: 'Explorar', path: '/explorar', current: true },
    { name: 'Blog', path: '/blog', current: true },
    { name: 'Contáctanos', path: '/contactanos', current: true },
    { name: 'Información', path: '/informacion', current: true },
];
...
export default function NavBar() {
    ...
    return (
        <Disclosure as="nav" className="border-bottom">
            {({ open }) => (<>
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 row p-3">
                                        ...
                                        <Menu.Item>
                                            {({ active }) => (
                                                <>
                                                    ...
                                                    <Link className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700')}>
                                                        Cerrar Sesión
                                                    </Link>
                                                </>
                                            )}
